"""
Contains tests for pynagios.response.PerfData
"""
...
class TestPerfData(object):
    ...
    def test_exception_if_minval_invalid(self):
        ...
        """
        with pytest.raises(ValueError):
            instance = PerfData("foo", "7", minval="foo")
    ...
    def test_exception_if_maxval_invalid(self):
        ...
        """
        with pytest.raises(ValueError):
            instance = PerfData("foo", "7", maxval="foo")
    ...
    def test_exception_if_invalid_uom(self):
        ...
        for value in invalids:
            with pytest.raises(ValueError):
                instance = PerfData("foo", "7", uom=value)
